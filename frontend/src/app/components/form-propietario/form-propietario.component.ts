...
export class FormPropietarioComponent implements OnInit {
  ...
  constructor(private propietarioService: PropietarioService, private formBuilder: FormBuilder,
  ...
  getPropietario(id : String){
    this.propietarioService.getPropietario(id).subscribe((data: Propietario)=> {
  ...
  addPropietario(){
    this.propietarioService.addPropietario(this.formPropietario.value).subscribe(() => {
  ...
  editPropietario(){
    this.propietarioService.editPropietario(this.formPropietario.value).subscribe((data) => {
      console.log(data);
      this.volverLista();
